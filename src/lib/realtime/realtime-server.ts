...
export class RealtimeServer {
  ...
  private triggerChanges(
    ...
    if (customEvent) {
      ...
      if (!valueOfUniqueProperty) {
        Helpers.error(
          `[Leo][Realtime] Entity without iD ! ${ClassHelpers.getName(
            entityFn,
          )} `,
          true,
          true,
  ...
  public triggerEntityChanges(
    ...
    if (this.core.ctx.disabledRealtime) {
      ...
      console.warn(
        `[Leo][TriggerEntityChanges] Entity "${className}' is not realtime`,
      );
      return;
    }
  ...
  public triggerEntityPropertyChanges(
    ...
    if (this.core.ctx.disabledRealtime) {
      ...
      console.warn(
        `[Leo][TriggerEntityPropertyChanges][property=${
          property as string
  ...
  public triggerEntityTableChanges(
    ...
    if (this.core.ctx.disabledRealtime) {
      console.warn(
        `[Leo][TriggerEntityTableChanges] Entity "${className}' is not realtime`,
      );
      return;
    }
